...
var currSongs;
var songNames;
var songs = [   { title: 'SAY MY GRACE (feat. Travis Scott)', artist: 'Offset, Travis Scott', imageURL: "images/set-if-off.jpg", moreinfo: 'Say My Grace is a song by American rapper Offset, featuring vocals from fellow American rapper and singer Travis Scott. It was released through Motown as the fourth single from Offsets second studio album, Set It Off, on October 13, 2023, along with the album.' },
...
const start = async() => {
    try {
        ...
        songNames = ['SAY MY GRACE', 'MELTDOWN (feat. Drake)', 'To The Bank', 'Rap Saved Me (feat. Quavo)', 'Superhero (Heroes & Villains) [with Future & Chris Brown]', 'Rap God', 'amari', 'Father Stretch My Hands Pt. 1', 'Sky'];
